...
import { SettingsProvider, ThemeSettings, useSettingsContext } from 'src/components/settings';
...
const App = (props) => {
  const { Component, pageProps, host, host_data } = props;
  const head_data = defaultManagerObj.brands;
